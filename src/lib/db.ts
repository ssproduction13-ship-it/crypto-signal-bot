...
CREATE TABLE IF NOT EXISTS journal_entries (
  ...
  entry_price NUMERIC(20,8) NOT NULL, stop_loss NUMERIC(20,8) NOT NULL,
  tp1 NUMERIC(20,8) NOT NULL, tp2 NUMERIC(20,8) NOT NULL,
  ...
  timestamp TEXT NOT NULL, closed_at TEXT, close_price NUMERIC(20,8),
  outcome TEXT, pnl_percent NUMERIC(20,8), error_analysis TEXT,
...
CREATE TABLE IF NOT EXISTS paper_positions (
  ...
  size NUMERIC(20,8) NOT NULL, stop_loss NUMERIC(20,8) NOT NULL,
  tp1 NUMERIC(20,8) NOT NULL, tp2 NUMERIC(20,8) NOT NULL,
  strategy TEXT NOT NULL DEFAULT 'TREND',
...
CREATE TABLE IF NOT EXISTS user_settings (
  ...
  account_size NUMERIC(20,8) NOT NULL DEFAULT 10000,
...
CREATE TABLE IF NOT EXISTS risk_state (
  id INTEGER PRIMARY KEY DEFAULT 1,
  daily_pnl_percent NUMERIC(20,8) NOT NULL DEFAULT 0,
  weekly_pnl_percent NUMERIC(20,8) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS missed_trades (
  ...
  direction TEXT NOT NULL, entry_price NUMERIC(20,8) NOT NULL,
  stop_loss NUMERIC(20,8) NOT NULL, tp1 NUMERIC(20,8) NOT NULL,
  tp2 NUMERIC(20,8) NOT NULL, score DOUBLE PRECISION NOT NULL,
...
CREATE TABLE IF NOT EXISTS strategy_stats (
  ...
  win_pnl NUMERIC(20,8) NOT NULL DEFAULT 0,
  loss_pnl NUMERIC(20,8) NOT NULL DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS notification_state (
  ...
  CREATE TABLE IF NOT EXISTS shadow_positions (
    ...
    stop_loss NUMERIC(20,8) NOT NULL, tp1 NUMERIC(20,8) NOT NULL, tp2 NUMERIC(20,8) NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS shadow_closed_trades (
    id TEXT PRIMARY KEY, symbol TEXT NOT NULL, direction TEXT NOT NULL,
    entry_price NUMERIC(20,8) NOT NULL, close_price NUMERIC(20,8) NOT NULL,
    pnl_percent NUMERIC(20,8) NOT NULL, outcome TEXT NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS instrument_analytics (
    ...
    trades INTEGER NOT NULL DEFAULT 0, wins INTEGER NOT NULL DEFAULT 0,
    win_pnl NUMERIC(20,8) NOT NULL DEFAULT 0, loss_pnl NUMERIC(20,8) NOT NULL DEFAULT 0,
    total_pnl NUMERIC(20,8) NOT NULL DEFAULT 0,
...
const MIGRATIONS = [
  ...
  "ALTER TABLE paper_positions ADD COLUMN IF NOT EXISTS final_score DOUBLE PRECISION",
    ...
    "CREATE INDEX IF NOT EXISTS idx_sandbox_orders_pending ON sandbox_orders(status, created_at)",
    "CREATE INDEX IF NOT EXISTS idx_sandbox_orders_order_id ON sandbox_orders(order_id)",
    ...
    "ALTER TABLE sandbox_positions ADD COLUMN IF NOT EXISTS multiplier NUMERIC(20,8) NOT NULL DEFAULT 1",
    ...
    "CREATE INDEX IF NOT EXISTS idx_sandbox_closed_trades_chat_closed ON sandbox_closed_trades(chat_id, closed_at DESC)",
