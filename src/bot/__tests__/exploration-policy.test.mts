...
import { BOOTSTRAP_ENTITY_TRADES, BOOTSTRAP_FINAL_SCORE_MIN, capBootstrapRisk, finalScoreMinimum, MATURE_FINAL_SCORE_MIN, EMULATOR_MATURE_FINAL_SCORE_MIN } from "../exploration-policy.ts";
...
test("bootstrap exploration remains bounded", () => {
  ...
  assert.equal(finalScoreMinimum(BOOTSTRAP_ENTITY_TRADES, "emulator"), EMULATOR_MATURE_FINAL_SCORE_MIN);
